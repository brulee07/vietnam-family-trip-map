const CACHE='family-travel-v11-5-2-preview-1';
const PREFIX='family-travel-';
const FILES=['./','./index.html','./app.css?v=11.5.2','./map-improvements.css?v=11.5.2','./home-improvements.css?v=11.5.2','./app.js?v=11.5.2','./ai-config.js?v=11.5.2','./manifest.json','./data/trip.json','./data/cities.json','./data/places.json','./data/itineraries.json','./data/safety.json','./icons/icon-192.png','./icons/icon-512.png'];
