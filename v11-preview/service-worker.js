const CACHE='family-travel-v11-9-1-preview-1';
const PREFIX='family-travel-';
const FILES=['./','./index.html','./app.css?v=11.9.1','./map-improvements.css?v=11.9.1','./home-improvements.css?v=11.9.1','./app.js?v=11.9.1','./ai-config.js?v=11.9.1','./manifest.json','./data/trip.json','./data/cities.json','./data/places.json','./data/itineraries.json','./data/safety.json','./icons/icon-192.png','./icons/icon-512.png'];
