const CACHE='family-travel-v11-preview-2';
const FILES=['./','./index.html','./app.css','./map-improvements.css','./app.js','./ai-config.js','./manifest.json','./data/trip.json','./data/cities.json','./data/places.json','./data/itineraries.json','./data/safety.json','./icons/icon-192.png','./icons/icon-512.png'];
