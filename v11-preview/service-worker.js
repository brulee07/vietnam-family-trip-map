const CACHE='family-travel-v11-8-preview-1';
const PREFIX='family-travel-';
const FILES=['./','./index.html','./app.css?v=11.8','./map-improvements.css?v=11.8','./home-improvements.css?v=11.8','./app.js?v=11.8','./ai-config.js?v=11.8','./manifest.json','./data/trip.json','./data/cities.json','./data/places.json','./data/itineraries.json','./data/safety.json','./icons/icon-192.png','./icons/icon-512.png'];
