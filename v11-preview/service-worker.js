const CACHE='family-travel-v11-9-preview-1';
const PREFIX='family-travel-';
const FILES=['./','./index.html','./app.css?v=11.9','./map-improvements.css?v=11.9','./home-improvements.css?v=11.9','./app.js?v=11.9','./ai-config.js?v=11.9','./manifest.json','./data/trip.json','./data/cities.json','./data/places.json','./data/itineraries.json','./data/safety.json','./icons/icon-192.png','./icons/icon-512.png'];
