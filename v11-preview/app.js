...
const KEY='familyTravelV11', PRE_RESTORE_KEY='familyTravelV11PreRestore', APP_VERSION='12.9-preview';
...
function save(){MemoCards.migrate(local);try{localStorage.setItem(KEY,JSON.stringify(local));return true;}catch{toast('이 기기에 저장할 수 없습니다. 여행 도구에서 파일로 백업해 주세요.');return false;}}
