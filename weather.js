...
function cityId(){const f=(location.pathname.split('/').pop()||'').replace('.html','');return CITY[f]?f:(document.body.dataset.city||'');}
async function load(force=false){
  const id=cityId(),c=CITY[id]; if(!c)return null;
